...
class Url {
    companion object {
        ...
        const val BASE_URL_PLACE_PHOTO = "https://maps.googleapis.com/maps/api/place/photo?photoreference=__photoreference__&maxheight=__maxheight__&maxwidth=__maxwidth__&key=__key__"
